...
const ALL_CARDS: Card[] = [
  ...
  {
    id: "kensei-ifraid",
    name: "Ultimate Guardian: Kensei Ifraid",
    image: "/images/kensei-ifraid.png",
    rarity: "UR",
    type: "ultimateGuardian",
    element: "Pyrus",
    dp: 0,
    ability: "KENSEI IFRAID",
    abilityDescription: "Quando equipada em Jaden, IFRAID concede os seguintes efeitos: Jaden ganha +3 DP. Voce pode selecionar e destruir 1 Card no campo do seu oponente. Se o Card destruido por este efeito for uma unidade, cause 4 DP de dano direto aos LP do oponente.",
    attack: "",
    category: "Pyrus Ultimate Guardian",
    requiresUnit: "Jaden Hainaegi",
  },
  {
    id: "mefisto-foles",
    name: "Ultimate Guardian: Mefisto Foles",
    ...
    abilityDescription: "Quando esta equipado em Arthur, ele concede os seguintes efeitos: Arthur ganha +2 DP. Voce pode selecionar 1 Card no campo do seu oponente e destrua-o. Esta habilidade de controle pode ser ativada somente uma unica vez por duelo.",
    attack: "",
    category: "Darkus Ultimate Guardian",
    requiresUnit: "Rei Arthur",
  },
  {
    id: "nightmare-armageddon",
    name: "Ultimate Guardian: Nightmare Armageddon",
    image: "/images/nightmare-armageddon.png",
    rarity: "UR",
    type: "ultimateGuardian",
    element: "Darkus",
    dp: 0,
    ability: "NIGHTMARE ARMAGEDDON",
    abilityDescription: "Quando esta equipado em Lil-Laep, ele concede os seguintes efeitos: Lil-Laep ganha +7 DP. Voce pode selecionar 1 Card de unidade com 3 ou menos de DP no campo do seu oponente e destrua-o. Esta habilidade so pode ser ativada somente uma unica vez.",
    attack: "",
    category: "Darkus Ultimate Guardian",
  ...
  {
    id: "isgrimm-fenrir",
    name: "Ultimate Guardian: Isgrimm Fenrir",
    image: "/images/isgrimm-fenrir.png",
    rarity: "UR",
    type: "ultimateGuardian",
    element: "Ventus",
    dp: 0,
    ability: "ISGRIMM FENRIR",
    abilityDescription: "Quando esta equipado em Unidade Ventus, ele concede os seguintes efeitos: Unidade Ventus ganha +2DP. Quando a Unidade Ventus ataca: Voce pode selecionar uma Carta de Unidade Ventus do seu campo e ela ganha +2DP, esse efeito nao pode ser aplicado na Unidade que esse Guardiao esta equipado.",
    attack: "",
    category: "Ventus Ultimate Guardian",
    requiresEquip: "FENRIR",
  },
  {
    id: "vatnavordr-messiham",
    name: "Ultimate Guardian: Vatnavordr Messiham",
    image: "/images/vatnavordr-messiham.png",
    rarity: "UR",
    type: "ultimateGuardian",
    element: "Aquos",
    dp: 0,
    ability: "VATNAVORDR MESSIHAM",
    abilityDescription: "Quando esta equipado em Hrotti, ele concede os seguintes efeitos: Hrotti ganha +2 DP. Uma vez por duelo, voce pode selecionar 1 carta no campo do oponente e negar seus efeitos, impedindo-o de atacar ou ser ativado ate o final do proximo turno do oponente (Congelamento). Se a carta selecionada for uma unidade, cause 2 DP de dano direto aos LP do oponente.",
    attack: "",
    category: "Aquos Ultimate Guardian",
    requiresUnit: "Scandinavian Angel Hrotti",
  },
  {
    id: "yggdra-nidhogg",
    name: "Ultimate Guardian: Yggdra Nidhogg",
    image: "/images/yggdra-nidhogg.png",
    rarity: "UR",
    type: "ultimateGuardian",
    element: "Pyrus",
    dp: 0,
    ability: "YGGDRA NIDHOGG",
    abilityDescription: "Quando esta equipado em Logi, ele concede os seguintes efeitos: Logi ganha +3 DP. Uma vez por duelo, voce pode selecionar 1 Carta de Funcao no campo do oponente e destrui-la.",
    attack: "",
    category: "Pyrus Ultimate Guardian",
    requiresUnit: "Scandinavian Angel Logi",
  },
  {
    ...
    image: "/images/ragna-gullinkambi.png",
    rarity: "UR",
    type: "ultimateGuardian",
    element: "Haos",
    dp: 0,
    ability: "RAGNA GULLINKAMBI",
    abilityDescription: "Quando esta equipado em Unidade Lightness, a unidade ganha +3 DP. No inicio de cada turno do jogador, coloque 1 Marcador de Pressagio nesta carta (max 5). A cada marcador, compre 1 carta. Com 5 marcadores: destrua todas as cartas do campo do oponente e reinicie a contagem.",
    attack: "",
    category: "Haos Ultimate Guardian",
    requiresEquip: "GULLINKAMBI",
  },
  {
    id: "skuggi-draugr",
    name: "Ultimate Guardian: Skuggi Draugr",
    image: "/images/skuggi-draugr.png",
    rarity: "UR",
    type: "ultimateGuardian",
    element: "Darkus",
    dp: 0,
    ability: "SKUGGI DRAUGR",
    abilityDescription: "Quando esta equipado em Unidade Darkness, a unidade ganha +3 DP. Uma vez por turno, voce pode selecionar 1 carta no seu cemiterio e coloca-la no topo do seu deck.",
    attack: "",
    category: "Darkus Ultimate Guardian",
    requiresEquip: "DRAUGR",
  },
  // SCENARIO CARDS
  {
    id: "reino-de-camelot",

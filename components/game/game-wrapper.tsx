    ...
    return (
      <div suppressHydrationWarning className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div suppressHydrationWarning className="text-center">
          <div suppressHydrationWarning className="w-16 h-16 border-4 border-cyan-400/30 border-t-cyan-400 rounded-full animate-spin mx-auto mb-4" />
          <p suppressHydrationWarning className="text-cyan-400 animate-pulse">Carregando...</p>
        </div>
      </div>
    )
  }
